               ...
               <div class="text-box">
                ...
                <div class="text-box">
                   ...
                   <select id="itemNo" name="itemNo">
                       <option value="1" ${param.artState == '1' ? 'selected' : ''}>策略型</option>
                       <option value="2" ${param.artState == '2' ? 'selected' : ''}>派對型</option>
                       <option value="3" ${param.artState == '3' ? 'selected' : ''}>親子型</option>
                       <option value="4" ${param.artState == '4' ? 'selected' : ''}>合作型</option>
                       <option value="5" ${param.artState == '5' ? 'selected' : ''}>陣營型</option>
                   </select>
                        <span id="itemNo.errors" class="error">${errorMsgs.itemNo}<br/></span>
                    </div>
                <div class="text-box">
